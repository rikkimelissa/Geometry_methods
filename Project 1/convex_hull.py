...
# Recursive function for finding covex hulls. Splits points in half by x-coord.
# If there are less than 3 points, uses a brute force method and otherwise uses
# merge_hulls method
...
# This function takes in two convex hulls that do not overlap in the x direction
